...
export const metadata: Metadata = {
  title: "Pawan Awasthi | Software Engineer",
  description:
  ...
  openGraph: {
    ...
    title: "Pawan Awasthi | Software Engineer",
    description:
      "Explore the portfolio of Pawan Awasthi, showcasing, skills, projects and achievements in software engineering.",
    type: "website",
    images: [
      {
        url: "/meta/ogg.jpeg",
  ...
  twitter: {
    ...
    title: "Pawan Awasthi - Software Engineer",
    description:
      "Discover the work and accomplishments of Pawan Awasthi in the field of software engineering.",
    images: [
      {
